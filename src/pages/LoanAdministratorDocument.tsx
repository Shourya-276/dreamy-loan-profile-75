...
/**
 * Loan Administrator Document Management Page
 * Handles document viewing, searching, and management for loan administrators
 */
const LoanAdministratorDocument: React.FC = () => {
...
export default LoanAdministratorDocument;
