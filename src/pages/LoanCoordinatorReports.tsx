  ...
  const handleDownloadExcel = async () => {
    try {
      ...
      const excelData = [
        { 
          "No. of Sanctions": "38", 
          "No. of First Disbursements": "25", 
          "Avg. Disbursement TAT": "7 days / 8 days", 
          "No. of Part Disbursements": "12", 
          "Avg. Sanctions TAT": "10 days / 15 days",
          "TAT (First Disbursement)": "7 days",
          "TAT (Part Disbursement)": "5 days"
        }
      ];
      ...
      const fileName = `Loan_Coordinator_Reports_${dateStr}.xlsx`;
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                  <tr>
                    <td className="px-6 py-4 text-sm text-gray-900 dark:text-gray-100">38</td>
                    <td className="px-6 py-4 text-sm text-gray-900 dark:text-gray-100">25</td>
                    <td className="px-6 py-4 text-sm text-gray-900 dark:text-gray-100">7 days / 8 days</td>
                    <td className="px-6 py-4 text-sm text-gray-900 dark:text-gray-100">12</td>
                    <td className="px-6 py-4 text-sm text-gray-900 dark:text-gray-100">10 days / 15 days</td>
                    <td className="px-6 py-4 text-sm text-gray-900 dark:text-gray-100">7 days</td>
                    <td className="px-6 py-4 text-sm text-gray-900 dark:text-gray-100">5 days</td>
                  </tr>
                </tbody>
              </table>
            </div>
