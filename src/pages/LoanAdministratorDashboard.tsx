  ...
  return (
    <LoanAdministratorLayout>
      <div className="space-y-6">
        <div>
          <h1 className="text-2xl font-bold">Loan Administrator Dashboard</h1>
          <p className="text-gray-600 dark:text-gray-400">Manage loan processing and administration</p>
        </div>
                ...
                {ongoingTasks.map((task, index) => (
                  <tr key={index}>
                    <td className="px-6 py-4 text-sm">
                      <button
                        onClick={() => navigate(`/loan-administrator-bank-sanctions?leadName=${encodeURIComponent(task.name)}`)}
