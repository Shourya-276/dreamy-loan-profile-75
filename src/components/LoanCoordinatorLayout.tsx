...
import { Home, User, Building, DollarSign, BarChart3, CheckSquare, Menu, X, BellDot, FileText } from "lucide-react";
...
const LoanCoordinatorLayout: React.FC<LoanCoordinatorLayoutProps> = ({ children }) => {
  ...
  const navLinks = [
    ...
    {
      to: "/loan-coordinator-document",
      icon: <FileText size={18} />,
      label: "Document",
      active: location.pathname === "/loan-coordinator-document",
    },
    {
