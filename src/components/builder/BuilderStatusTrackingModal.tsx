...
interface BuilderStatusTrackingModalProps {
  isOpen: boolean;
  onClose: () => void;
  leadName?: string;
}

const BuilderStatusTrackingModal: React.FC<BuilderStatusTrackingModalProps> = ({
  isOpen,
  onClose,
  leadName = "Customer"
}) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-lg bg-white border border-gray-200 shadow-lg rounded-lg p-0">
...
export default BuilderStatusTrackingModal;
