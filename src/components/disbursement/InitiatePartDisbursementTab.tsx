...
import InitiateDisbursementModal from "./InitiateDisbursementModal";

const InitiatePartDisbursementTab = () => {
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <p className="font-semibold">₹5,50,000</p>
            </div>
          </div>
...
export default InitiatePartDisbursementTab;
